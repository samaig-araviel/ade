...
const models: ModelDefinition[] = [
    ...
    // Claude Opus 4.6 - NEWEST FLAGSHIP (Feb 5, 2026)
    {
        id: 'claude-opus-4-6',
    ...
    // Claude Sonnet 4.6 - NEWEST DEFAULT (Feb 17, 2026)
    {
    ...
    // GPT-5.2 - Flagship reasoning model
    {
        ...
        name: 'GPT-5.2',
        provider: 'openai',
        description: 'Flagship reasoning model for coding and agentic tasks. Best overall model with configurable reasoning effort (none/low/medium/high/xhigh).',
        pricing: {
            inputPer1k: 0.00175,
            outputPer1k: 0.014,
            cachedInputPer1k: 0.000175, // 90% prompt caching discount
        },
        capabilities: {
