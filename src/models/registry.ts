...
const models: ModelDefinition[] = [
...

    {
        ...
        humanFactors: {
            empathyScore: 0.78, playfulnessScore: 0.72, professionalismScore: 0.96,
            conciseness: 0.70, verbosity: 0.88, conversationalTone: 0.75,
            formalTone: 0.95, lateNightSuitability: 0.75, workHoursSuitability: 0.96,
        },
...

    {
        ...
        humanFactors: {
            empathyScore: 0.76, playfulnessScore: 0.68, professionalismScore: 0.98,
            conciseness: 0.65, verbosity: 0.92, conversationalTone: 0.70,
            formalTone: 0.97, lateNightSuitability: 0.70, workHoursSuitability: 0.96,
        },
        specializations: ['reasoning', 'math'],
        available: true,
    },

    {
        ...
        humanFactors: {
            empathyScore: 0.76, playfulnessScore: 0.70, professionalismScore: 0.94,
            conciseness: 0.72, verbosity: 0.86, conversationalTone: 0.74,
            formalTone: 0.94, lateNightSuitability: 0.74, workHoursSuitability: 0.94,
        },
...

    {
        ...
        humanFactors: {
            empathyScore: 0.74, playfulnessScore: 0.68, professionalismScore: 0.92,
            conciseness: 0.74, verbosity: 0.84, conversationalTone: 0.72,
            formalTone: 0.92, lateNightSuitability: 0.72, workHoursSuitability: 0.92,
        },
...

    {
        ...
        humanFactors: {
            empathyScore: 0.78, playfulnessScore: 0.74, professionalismScore: 0.90,
            conciseness: 0.85, verbosity: 0.75, conversationalTone: 0.80,
            formalTone: 0.88, lateNightSuitability: 0.85, workHoursSuitability: 0.92,
        },
...

    {
        ...
        humanFactors: {
            empathyScore: 0.65, playfulnessScore: 0.55, professionalismScore: 0.95,
            conciseness: 0.70, verbosity: 0.85, conversationalTone: 0.62,
...

    {
        ...
        humanFactors: {
            empathyScore: 0.62, playfulnessScore: 0.55, professionalismScore: 0.90,
            conciseness: 0.88, verbosity: 0.65, conversationalTone: 0.60,
            formalTone: 0.90, lateNightSuitability: 0.85, workHoursSuitability: 0.92,
        },
...

    {
        ...
        humanFactors: {
            empathyScore: 0.82, playfulnessScore: 0.78, professionalismScore: 0.94,
            conciseness: 0.80, verbosity: 0.85, conversationalTone: 0.82,
            formalTone: 0.94, lateNightSuitability: 0.80, workHoursSuitability: 0.95,
        },
        specializations: ['general_purpose'],
        available: true,
    },

    {
        ...
        humanFactors: {
            empathyScore: 0.78, playfulnessScore: 0.75, professionalismScore: 0.88,
            conciseness: 0.90, verbosity: 0.70, conversationalTone: 0.82,
...

    {
        ...
        humanFactors: {
            empathyScore: 0.80, playfulnessScore: 0.82, professionalismScore: 0.85,
            conciseness: 0.88, verbosity: 0.70, conversationalTone: 0.88,
            formalTone: 0.82, lateNightSuitability: 0.90, workHoursSuitability: 0.88,
        },
...

    {
        ...
        humanFactors: {
            empathyScore: 0.70, playfulnessScore: 0.60, professionalismScore: 0.95,
            conciseness: 0.65, verbosity: 0.92, conversationalTone: 0.68,
            formalTone: 0.95, lateNightSuitability: 0.72, workHoursSuitability: 0.95,
        },
        specializations: ['reasoning', 'math'],
        available: true,
    },

    {
        ...
        humanFactors: {
            empathyScore: 0.68, playfulnessScore: 0.55, professionalismScore: 0.96,
            conciseness: 0.60, verbosity: 0.95, conversationalTone: 0.62,
            formalTone: 0.96, lateNightSuitability: 0.65, workHoursSuitability: 0.95,
        },
        specializations: ['reasoning', 'math'],
        available: true,
    },

    {
        ...
        humanFactors: {
            ...
            conciseness: 0.78, verbosity: 0.82, conversationalTone: 0.72,
            formalTone: 0.90, lateNightSuitability: 0.78, workHoursSuitability: 0.92,
        },
